        ...
        <div class="card-body ">
            <div class="row">
                <div class="col-md-12  d-flex justify-content-between align-items-center">
                    <h5 class="display-5">Create Mission</h5>
                  <a href="{{route('missions.view')}}" class="btn btn-warning text-dark"> <i class="fa fa-list"></i> Mission List</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-6 offset-3 pt-3">
            <form action="{{route('missions.store')}} " method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="title" id=""  type="text"  rows="10" placeholder="Write Your Massage Here" required></textarea>
