        ...
        <div class="card-body ">
            <div class="row">
                <div class="col-md-12  d-flex justify-content-between align-items-center">
                    <h5 class="display-5">Create News And Event</h5>
                  <a href="{{route('newsevents.view')}}" class="btn btn-warning text-dark"> <i class="fa fa-list"></i> News And Event List</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-6 offset-3 pt-3">
            <form action="{{route('newsevents.store')}} " method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input id="my-input" class="form-control" type="date" name="date" placeholder="YYYY/MM/DD" id="datepicker" required>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="long_title" id=""  type="text"  rows="10" placeholder="Write Your Massage Here" required></textarea>
